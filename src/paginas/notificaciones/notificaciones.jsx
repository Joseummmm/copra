...
export const Notificaciones = ({ practicas }) => {
  return (
    <div class="border p-4 flex justify-center items-center">
          ...
          <div class="border border-black rounded-lg col-span-1 p-5 bg-gray-50 drop-shadow-lg grid grid-cols-8">
            <div class="flex items-start justify-start">
              <img
                src={logo}
                alt=""
                class="mx-auto w-20 rounded-2xl drop-shadow-lg"
              />
            </div>
            ...
            <div class="grid grid-cols-1 justify-center items-center">
              <img src={aprobado} alt="" class="px-4" />
            </div>
          </div>
        </div>
        <div class="col-span-1 p-4">
          <div class="border border-black rounded-lg col-span-1 p-5 bg-gray-50 drop-shadow-lg grid grid-cols-8">
            ...
            <div class="grid grid-cols-1 justify-center items-center">
              <img src={noAprobado} alt="" class="px-4" />
            </div>
          </div>
        </div>
      </div>
